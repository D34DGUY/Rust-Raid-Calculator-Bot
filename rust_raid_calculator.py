...
async def help(interaction: discord.Interaction):
    await interaction.response.send_message(embed = discord.Embed(colour=discord.Color.red(), title="To Calculate", description=
                                            ...
                                            f"\n"
                                            f"\n**Rocket :**"
                                            f"\n/rocket (ammount of Rockets)"
                                            f"\n"
                                            f"\n**Timed Explosive Charge :**"
                                            f"\n/c4 (ammount of Timed Explosive Charge)"
                                            f"\n"
                                            f"\n**Explosive Ammo :**"
                                            f"\n/explosive_ammo (ammount of Explosive Ammo)"
                                            f"\n"
                                            f"\n**Satchel Charge :**"
                                            f"\n/satchel_charge (ammount of Satchel Charges)"
                                            f"\n"
                                            f"\n**Beancan Grenade :**"
                                            f"\n/beancan_grenade (ammount of Beancan Grenade)"
                                            f"\n"
                                            f"\n**F1 Grenade :**"
                                            f"\nf1_grenade (ammount of F1 Grenade)"
                                            f"\n"
                                            f"\n**High Velocity Rockets :**"
                                            f"\n/high_velocity_rocket (ammount of High Velocity Rocket)"
                                            f"\n"
                                            f"\n**Explosive :**"
                                            f"\n/explosive (ammount of Explosives)"
                                            f"\n"
                                            f"\n**Incendiary Rocket :**"
                                            f"\n/incendiary_rocket (ammount of Incendiary Rockets)"
                                            f"\n"
                                            f"\n**----------------------| DURABILITY |-------------------------**"
                                            f"\n"
                                            f"\n**Wooden Walls :**"
                                            f"\n/wooden_wall (ammount of Wooden Walls)"
                                            f"\n"
                                            f"\n**Stone Walls :**"
                                            f"\n/stone_wall (ammount of Stone Walls)"
                                            f"\n"
                                            f"\n**Metal Walls :**"
                                            f"\n/metal_wall (ammount of Metal Walls)"
                                            f"\n"
                                            f"\n**Armored Walls :**"
                                            f"\n/armored_wall (ammount of Armored Walls)"
                                            f"\n"
                                            f"\n**Wooden Doors :**"
                                            f"\n/wooden_door (ammount of Wooden Doors)"
                                            f"\n"
                                            f"\n**Sheet Metal Door :**"
                                            f"\n/sheet_metal_door (ammount of Sheet Metal Doors)"
                                            f"\n"
                                            f"\n**Garage Doors :**"
                                            f"\n/garage_door (ammount of Garage Doors)"
                                            f"\n"
                                            f"\n**Armored Doors :**"
                                            f"\n/armored_door (ammount of Armored Doors)"
                                            f"\n"
                                            f"\n**High External Wooden Walls :**"
                                            f"\n/high_external_wooden_wall (ammount of High External Wooden Walls)"
                                            f"\n"
                                            f"\n**High External Stone Walls :**"
                                            f"\n/high_external_stone_wall (ammount of High External Stone Walls)"
                                            f"\n"
                                            f"\n"
                                            f"\n"
                                            f"\n*made by Nomad 1-1*"))
